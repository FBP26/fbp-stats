...
test('admin rejects cross-origin and forged-host access and records validated edits', async () => {
  ...
  const port = 18819;
  const body = { name: 'Example', weeks: Array(19).fill(''), balance: '20', notes: '', provenance: { original: true } };
  ...
  try {
    ...
    const request = { kind: 'payout', recordId: 'payout:test', operationId: 'owner-admin-edit-01', expectedVersion: 1, expectedEpoch: 1, reason: 'Payment recorded', changes: { balance: 'even' } };
